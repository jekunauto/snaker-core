...
public class QueryService extends AccessService implements IQueryService {
	...
	public List<HistoryTask> getHistoryRelateTasks(QueryFilter filter) {
		AssertHelper.notNull(filter);
		return access().getHistoryRelateTasks(null, filter);
	}

	public List<HistoryTask> getHistoryRelateTasks(Page<HistoryTask> page, QueryFilter filter) {
		AssertHelper.notNull(filter);
		return access().getHistoryRelateTasks(page, filter);
	}
